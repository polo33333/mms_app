...
import 'householdBusiness_selectProductGroup.dart';

class HouseholdBusinessSelectMarketScreen extends StatefulWidget {
  @override
  _HouseholdBusinessSelectMarketScreenState createState() =>
      _HouseholdBusinessSelectMarketScreenState();
}

class _HouseholdBusinessSelectMarketScreenState
    extends State<HouseholdBusinessSelectMarketScreen> {
                            ...
                            subtitle: Column(
                              ...
                              children: [
                                LineData(
                                    ...
                                    value: post.tHCTNTONG == null
                                        ? '0'
                                        : post.tHCTNTONG.toString()),
                                LineData(
                                    title: "Thương nhân đang hoạt động: ",
                                    value: post.tHCTNDHD == null
                                        ? '0'
                                        : post.tHCTNDHD.toString()),
                              ],
                            ),
                            onTap: () {
                              Navigator.push(
                                ...
                                PageTransition(
                                    ...
                                    child:
                                        HouseholdBusinessSelectProductGroupScreen(
