...
class KiotSelectRegionScreen extends StatefulWidget {
  int marketId;
  KiotSelectRegionScreen({this.marketId});

  @override
  _KiotSelectRegionScreenState createState() => _KiotSelectRegionScreenState();
}

class _KiotSelectRegionScreenState extends State<KiotSelectRegionScreen> {
                                  ...
                                  subtitle: Column(
                                    ...
                                    children: [
                                      ...
                                      LineData(
                                          ...
                                          value: _data.sDKDDHD == null
                                              ? '0'
                                              : _data.sDKDDHD.toString()),
                                    ],
                                  ),
                                  onTap: () {
                                    Navigator.push(
